...
class ConfigData{
	public:
		// Constructor
		ConfigData(int len1, int len2, int len3, int len4, int md);
		~ConfigData();
...
//-----------------------------------------------------------------------------------------------
ConfigData::ConfigData(int len1, int len2, int len3, int len4, int md)
{
      ...
      for(int i3 = 0;i3<leng3;i3++){
        ...
        for(int i4 = 0;i4<leng4;i4++){
          ...
          isp3 = i1 + i2*leng1 + i3p*leng1*leng2 +
								 i4*leng1*leng2*leng3;
          isp4 = i1 + i2*leng1 + i3*leng1*leng2 +
								 i4p*leng1*leng2*leng3;
          ...
          ism3 = i1 + i2*leng1 + i3m*leng1*leng2 +
								 i4*leng1*leng2*leng3;
          ism4 = i1 + i2*leng1 + i3*leng1*leng2 +
								 i4m*leng1*leng2*leng3;
